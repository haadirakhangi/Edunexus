...
import SimpleThreeColumns from './course_overview/SimpleThreeColumns';
...
export default function Simple() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const source_lang = localStorage.getItem('source_lang');
            try {
                const response = await axios.get(`/api/student/query2/course-overview/${moduleid}/${source_lang}/${websearch}`);
