...
import MyCard from "./explore/ExploreCard"
...
function Modules() {
  ...
  const onLearnClick = async () => {
    ...
    if (selectedFile!=null){
        await fetchdocData(`/api/student/query2/doc-upload/${searchTerm}/beginner/${sourceLanguage}`, setBeginnerData, setBeginnerModuleIdData);
        await fetchdocData(`/api/student/query2/doc-upload/${searchTerm}/advanced/${sourceLanguage}`, setAdvancedData, setAdvanceModuleIdData);
     
    }
    else {
      await fetchData(`/api/student/query2/${searchTerm}/beginner/${webSearchOn}/${sourceLanguage}`, setBeginnerData, setBeginnerModuleIdData);
      await fetchData(`/api/student/query2/${searchTerm}/advanced/${webSearchOn}/${sourceLanguage}`, setAdvancedData, setAdvanceModuleIdData);
    }
  };
