...
class ContentGenerator:
    ...
    def generate_content(self, sub_modules, module_name, course_name, api_key_to_use):
    ...
    def generate_content_from_web(self, sub_modules, module_name, course_name, api_key_to_use):
