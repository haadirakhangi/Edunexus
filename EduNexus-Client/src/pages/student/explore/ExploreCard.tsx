      ...
      <Flex justify="center" align="center">
        <CardFooter>
          <ButtonGroup spacing="2">
            <Button bg={"purple.700"} color={"white"} _hover={{bg:useColorModeValue('purple.800', 'purple.800'), color: "white", transform: "scale(1.05)" }} variant="solid"  onClick={handleStartLearning} size={'md'}>
